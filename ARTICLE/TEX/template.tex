...
\section{Experiment}
In the experiment, various scenarios were tested. In each of them, the person on whom the experiment is carried out was asked to always look forward, with the freedom to move their head, without squinting eyes to ensure that both th eye-tracker and light detector will give the best results. The figures presented below show the deviation that can be treated as non-light triggered changes. Data from luxometer and eye-tracker gathered along the experiment was used to generate the artificial signal using \Ref{equ}{equ:Pampelona}, plotted as solid line. The real data, points, was plotted against the generated one to find how much those two signals differ at, example at \Ref{fig}{fig:experiment}. All not convergence is treated as pupil change caused by non-light factors, such as emotion, accommodation, etc. 
...
To compare data gathered by device and data calculated by Pamplona (\Ref{equ}{equ:Pampelona}) the difference in pupil size have been calculated.
For experiment presented at \Ref{fig}{fig:experiment1} the difference was plotted at    \Ref{fig}{fig:Resoults1} where the mean difference in distance is $-0.215916$mm.
For second experiment presented at \Ref{fig}{fig:experiment2} the difference was plotted at    \Ref{fig}{fig:Resoults2} where the mean difference in distance is $0.041678$mm.
For third experiment presented at \Ref{fig}{fig:experiment3} the difference was plotted at    \Ref{fig}{fig:Resoults3} where the mean difference in distance is $-0.278634$mm.
